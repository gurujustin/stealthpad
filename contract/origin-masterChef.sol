...
contract PunkToken is BEP20('StealthPad Token', 'STEALTH') {
    uint256 public constant MAX_SUPPLY = 230000000 ether;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "STEALTH::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "STEALTH::delegateBySig: invalid nonce");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "STEALTH::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "STEALTH::_writeCheckpoint: block number exceeds 32 bits");
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    function updatePool(uint256 _pid) public {
        ...
        punk.mint(devAddress, tokenReward.mul(devRewardPercent).div(10000));
    ...
    function setBurnRate(uint8 _burnRate) external onlyOwner {
        require(_burnRate > 0 && burnRate < 1, "0 < burnRate < 1");
        burnRate = _burnRate;
    }
}